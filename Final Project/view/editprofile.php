            ...
            <td colspan="2">
                ...
                <script>
                    function validateFields() {
                        ...
                        let day = document.getElementsByName("dob-day")[0].value;
                        let month = document.getElementsByName("dob-month")[0].value;
                        let year = document.getElementsByName("dob-year")[0].value;
